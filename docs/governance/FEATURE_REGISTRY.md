...
| FEAT-018 | Authentication and user identity | protected routes/signed development actor | backend auth providers | BACKEND | PARTIAL | No production login/session provider; commercial release blocker |
