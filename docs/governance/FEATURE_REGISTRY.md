...
| FEAT-018 | Authentication and user identity | frozen Auth0 + Next.js BFF contract; runtime still uses protected routes/signed development actor | `docs/AUTH_SESSION_CONTRACT.md`; backend auth providers | SOL -> DATABASE/BACKEND/FRONTEND/QA DAG | PARTIAL | `CONTRACT_FROZEN_IMPLEMENTATION_PENDING`; AUTH-002 through AUTH-007 not started |
