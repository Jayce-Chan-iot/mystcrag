...
Provider output is checked independently and conservatively with both a positive policy and restricted-pattern checks. Every creative field must be anchored in approved card/reflection or bracelet/design/visual/material language, including validated server-derived card, palette, and material terms. Definite future assertions about the user's life or external outcomes, diagnoses or medical-condition assertions, Crystal/material efficacy claims, death or lifespan assertions, finance/return/windfall claims, authoritative commands, and disclosure or use of hidden/private/internal/system instructions, rules, or directives select deterministic fallback. Concrete visual future tense is accepted only through a narrow placement/preview exception, such as a blue bead that "will sit" beside a pearl. Uncertain or questionable prose falls back rather than being surfaced.
