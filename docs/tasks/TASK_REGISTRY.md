...
| TASK-AUTH-007 | SOL | P0 | TASK-AUTH-006 DONE | `task/auth-007-final-integration` | BLOCKED: integration/workspace/PostgreSQL/54-test security E2E/cleanup/artifact gates pass, but final acceptance lacks (1) an authorized numeric session-lookup p95 budget and measurement rule and (2) byte-exact staging/production Auth0 allowlists plus real login/logout smoke evidence; no new Feature, auth redesign, P1/P2 work or weakened AUTH-006 gate is authorized |
