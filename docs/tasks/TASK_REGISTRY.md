...
| TASK-AUTH-004 | BACKEND / GLM | P0 | TASK-AUTH-003 DONE | `task/auth-004-backend-provider` | READY: production verifier and authenticated actor composition; BACKEND owner must claim the registered branch/worktree before implementation |
