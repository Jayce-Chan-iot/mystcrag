...
| TASK-AUTH-002 | SOL | P0 | TASK-AUTH-001 DONE | `task/auth-002-dependency-baseline` | REVIEW: exact identity dependencies, lockfile and `MYSTCRAG_*` environment mapping await SOL integration; AUTH-003/004/005 remain blocked until DONE |
