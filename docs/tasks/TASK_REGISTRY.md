...
| TASK-AUTH-006 | QA / GLM | P0 | TASK-AUTH-004, TASK-AUTH-005 DONE | `task/auth-006-security-e2e` | READY: dependencies closed; requires a newly claimed isolated branch/worktree and exact QA/CI path lock before implementation |
