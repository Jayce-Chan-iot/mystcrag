...
export const KNOWLEDGE_DOCUMENT_FIXTURES: readonly KnowledgeDocument[] = [
  ...
  {
    id: "doc-fixture-bootstrap",
    sourceId: "source-fixture-bootstrap",
    url: "https://fixtures.mystcrag.internal/corpus-bootstrap",
    contentHash: "b".repeat(64),
    title: "语料引导生成层",
    contentText:
      "Deterministic taxonomy-coverage and combination layers reviewed with the handbook corpus.",
    fetchedAt: "2026-08-21T12:00:00+08:00",
    parser: "corpus-bootstrap",
    language: "zh-CN",
    status: "FETCHED"
  }
];
